...
const casesData = {
  ...
  'extrum': {
    ...
    plantSummary:     "2 presses with RO3 · Honduras · Pressezi and Mei Ruey.",
  ...
  'indalum': {
    ...
    plantSummary:     "3 presses · Mexico · Full plant conversion from graphite to Interforge KI-C.",
    plantDescription: "INDALUM operated 3 extrusion presses using graphite bars across all lubrication points. Each press consumed 2 graphite bars per shift, running 3 shifts per day, 26 days per month. Graphite residue contaminated profiles, fouled equipment, and drove up maintenance costs. The entire plant was converted to Interforge KI-C, using the existing automated dosing systems that came with each press, eliminating graphite entirely and reducing lubricant expenditure by 75%.",
    ...
    verificationNote: "All figures recorded on-site by Interlub's technical team at INDALUM, Mexico. Reference: November 2022. Available for third-party audit.",
